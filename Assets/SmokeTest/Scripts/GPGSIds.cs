...
namespace SmokeTest
{
    public static class GPGSIds
    {
         ...
         */
        public const string
            achievement_achievementtoincrement = "CgkIs_7WrdEcEAIQAg"; // <GPGSID>

        public const string achievement_achievementtounlock = "CgkIs_7WrdEcEAIQAQ"; // <GPGSID>
        public const string achievement_achievementtoreveal = "CgkIs_7WrdEcEAIQAA"; // <GPGSID>
        ...
        public const string
            leaderboard_leaders_in_smoketesting = "CgkIs_7WrdEcEAIQBA"; // <GPGSID>
    }
}